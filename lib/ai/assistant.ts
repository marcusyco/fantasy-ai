...
function buildSystemPrompt(params: {
  ...
  return [
    ...
    '',
    'When asked to evaluate a trade or give it a grade, search for current expert-consensus rankings',
    '(FantasyPros, ESPN, RotoWire, and similar) for every player involved rather than judging value',
    'off name recognition or past-season performance. Weigh those rankings alongside this league\'s',
    'specific context below — keeper eligibility, auction/keeper cost, and roster construction — since',
    'a trade that looks even on national rankings can be lopsided once keeper value is factored in.',
    '',
    audience,
    '',
